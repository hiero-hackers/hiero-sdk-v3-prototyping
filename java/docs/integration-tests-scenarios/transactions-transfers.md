...
> **Implementation:** `TransferTransactionHooksIntegrationTest.transferWithPreTransactionAllowanceHookSucceeds`  
> **Source:** `sdk/src/testIntegration/java/com/hedera/hashgraph/sdk/test/integration/TransferTransactionHooksIntegrationTest.java:19`
...
> **Implementation:** `TransferTransactionHooksIntegrationTest.multipleAccountsHooksMustAllApprove`  
> **Source:** `sdk/src/testIntegration/java/com/hedera/hashgraph/sdk/test/integration/TransferTransactionHooksIntegrationTest.java:61`
> **Status:** Disabled — Temporarily disabled, EVM Hooks are not enabled in v0.73.0
...
> **Implementation:** `TransferTransactionHooksIntegrationTest.transferWithPrePostTransactionAllowanceHookSucceeds`  
> **Source:** `sdk/src/testIntegration/java/com/hedera/hashgraph/sdk/test/integration/TransferTransactionHooksIntegrationTest.java:130`
> **Status:** Disabled — Temporarily disabled, EVM Hooks are not enabled in v0.73.0
...
> **Implementation:** `TransferTransactionHooksIntegrationTest.fungibleTokenTransferWithAllowanceHookSucceeds`  
> **Source:** `sdk/src/testIntegration/java/com/hedera/hashgraph/sdk/test/integration/TransferTransactionHooksIntegrationTest.java:173`
> **Status:** Disabled — Temporarily disabled, EVM Hooks are not enabled in v0.73.0
...
> **Implementation:** `TransferTransactionHooksIntegrationTest.nftTransferWithAllowanceHookSucceeds`  
> **Source:** `sdk/src/testIntegration/java/com/hedera/hashgraph/sdk/test/integration/TransferTransactionHooksIntegrationTest.java:263`
> **Status:** Disabled — Temporarily disabled, EVM Hooks are not enabled in v0.73.0
...
> **Implementation:** `TransferTransactionHooksIntegrationTest.senderAndReceiverHooksExecuteForHbarTransfer`  
> **Source:** `sdk/src/testIntegration/java/com/hedera/hashgraph/sdk/test/integration/TransferTransactionHooksIntegrationTest.java:362`
> **Status:** Disabled — Temporarily disabled, EVM Hooks are not enabled in v0.73.0
